defmodule Surge.DDLTest do
  ...
  test "HashRangeModel" do
    ...
    assert global_secondary_index["KeySchema"] == [
             %{"AttributeName" => "age", "KeyType" => "HASH"},
             %{"AttributeName" => "sex", "KeyType" => "RANGE"}
           ]

    assert global_secondary_index["ProvisionedThroughput"] == %{
             "ReadCapacityUnits" => 5,
  ...
  test "GlobalIndexModel" do
    ...
    assert global_secondary_index["IndexName"] ==
             "Surge.Test.GlobalIndexModel.indexes.address_age"
  ...
  test "No Table" do
    ...
    assert_raise Surge.Exceptions.ResourceNotFoundException,
                 "Cannot do operations on a non-existent table",
                 fn -> describe_table(NoTableModel) end
  end
end
